...
} from '@hzcore/gesture-observable';
...
const observable: Observable<TouchGestureState> = TouchGestureObservable.create(
...
interface TouchGestureState {
  ...
  type: 'touchstart' | 'touchmove' | 'touchend' | null;
}
```
...
const observable: Observable<MouseGestureState> = MouseGestureObservable.create(
...
interface MouseGestureState {
  ...
  gesturing: boolean;
  /** The type of event last associated with a gesture. */
  type: 'mousedown' | 'mousemove' | 'mouseup' | null;
}
```
...
const observable: Observable<WheelGestureState> = WheelGestureObservable.create(
...
const observable: Observable<KeyboardGestureState> = KeyboardGestureObservable.create(
